...
getgenv().sailorPieceConfig = {  
    ...
    MULTI_FARM = { "FastNinja", "StrongBandit", "StrongFighter", "Delinquent", "Bunny", "ArenaFighter", "Ninja", "Swordsman", "AcademyTeacher", "Slime", "StrongSorcerer", "Curse", "Hollow" },  
    -- Ascend/Quest/Weapon Requirements will auto summon + attack
    AUTO_FARM = { "IceQueenBoss", "Great Mage Boss", "Cosmic Being", "The World Boss", "The World Boss", "Cosmic Being Boss", "TheWorldBoss", "CosmicBeingBoss" },  -- Auto farm ascend/quest/weapon bosses 
    SUMMON_BOSS = { "Great Mage Normal", "Ice Queen Normal" },  -- Auto summon ascend/quest/weapon bosses
