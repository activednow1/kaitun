...
getgenv().sailorPieceConfig = {  
    ...
    AUTO_FARM = { "Great Mage Boss", "Cosmic Being", "The World Boss", "The World Boss", "Cosmic Being Boss", "TheWorldBoss", "CosmicBeingBoss" },  -- Auto farm ascend/quest/weapon bosses 
