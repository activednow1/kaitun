...
getgenv().sailorPieceConfig = {  
    ...
    AUTO_FARM = { "IceQueenBoss", "AtomicBoss", "MoonSlayerBoss",  "IchigoBoss",  "Ichigo Boss", "RimuruBoss", "TrueAizenBoss", "AizenBoss", "SoulReaperBoss", "Soul Reaper"  },  -- Auto farm ascend/quest/weapon bosses
    SUMMON_BOSS = { "Ice Queen Normal", "Soul Reaper Normal", "Soul Reaper", "Gilgamesh Normal", "Moon Slayer Normal", "Ichigo Normal", "Saber Normal", "AtomicBoss Normal", "Atomic Normal" },  -- Auto summon ascend/quest/weapon bosses
