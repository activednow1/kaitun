...
getgenv().sailorPieceConfig = {  
    ...
    SUMMON_BOSS = { "Ice Queen Normal", "Ice Queen Medium", "Ice Queen Medium", "Ice Queen Normal", "Great Mage Normal", "Ichigo Normal" },  -- Auto summon ascend/quest/weapon bosses
